...
module.exports = (app) => {
    ...
    app.delete('/admin/category/delete/:id', CategoryController.handleDeleteById)
    ...
    //User
    app.get('/category/find_all_post_number', CategoryController.handleFindAllWithPostNumber)
}
